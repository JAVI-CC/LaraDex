...
Vue.component('create-form-pokemon', require('./components/pokemons/add').default);
Vue.component('spinner', require('./components/widgets/spinner.vue').default);

Vue.component('principal-button', require('./components/pokemons/principal-button.vue').default);
